//===-- Linux implementation of pwrite wrapper ------------------*- C++ -*-===//
//
...
#ifndef LLVM_LIBC_SRC___SUPPORT_OSUTIL_LINUX_SYSCALL_WRAPPERS_PWRITE_H
#define LLVM_LIBC_SRC___SUPPORT_OSUTIL_LINUX_SYSCALL_WRAPPERS_PWRITE_H
...
#else
#error "SYS_pwrite64 syscall not available."
#endif
}
...
#endif // LLVM_LIBC_SRC___SUPPORT_OSUTIL_LINUX_SYSCALL_WRAPPERS_PWRITE_H
