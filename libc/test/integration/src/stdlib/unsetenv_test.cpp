...
TEST_MAIN([[maybe_unused]] int argc, [[maybe_unused]] char **argv,
  ...
  // Test: SetUnsetSet
  {
    ...
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("TOGGLE_VAR"), "first"),
        0);
    ...
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("TOGGLE_VAR"), "second"),
        0);
  ...
  // Test: UnsetDoesNotAffectOthers
  {
    ...
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("KEEP_VAR1"), "keep1"),
        0);
    ASSERT_TRUE(LIBC_NAMESPACE::getenv("REMOVE_VAR") == nullptr);
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("KEEP_VAR2"), "keep2"),
        0);
  ...
  // Test: UnsetSimilarNames
  {
    ...
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("VARIABLE"), "value2"),
        0);
    ASSERT_EQ(
        LIBC_NAMESPACE::strcmp(LIBC_NAMESPACE::getenv("VAR_NAME"), "value3"),
        0);
